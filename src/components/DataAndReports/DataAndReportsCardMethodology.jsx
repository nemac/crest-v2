      ...
      <StyledPaper variant="outlined" square={false}>
        ...
        >
          <Typography variant="body1" component="div" gutterBottom>
            Report provides a summary of overarching methods and data sources
            used for all U.S. Caribbean and Pacific Islands.
          </Typography>
        </Box>
        ...
        <Grid container justifyContent="start" alignItems="start" pt={1}>
          ...
          <Grid item xs={11} sm={11.5}>
            <Link
              href="https://www.nfwf.org/sites/default/files/2022-04/methodology-data-report-us-caribbean-pacific-islands.pdf"
              target="_blank"
            >
              Regional Methodology and Data Report
            </Link>
          </Grid>
        </Grid>
      </StyledPaper>
