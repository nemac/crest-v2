...
export default function AboutTabs (props) {
  ...
  return (
    <Box  px={3} py={0.75} >
        <Grid container spacing={2} justifyContent="center" alignItems="center" px={3} py={0.75} sx={{ display: { xs: 'none', md: 'flex'} }}>
          <Grid item xs={12} >
        ...
        <Grid container spacing={2} justifyContent="center" alignItems="center" px={4} py={1} sx={{ display: { xs: 'flex', md: 'none'} }} >
        ...
        <Grid container spacing={2} justifyContent="center" alignItems="center" px={4} pt={1} sx={{ display: { xs: 'flex', md: 'none'} }} >
          <Grid item xs={12} className={classes.item}>
            <Box  py={0.75} className={classes.descriptionBox} >
              <Paper variant="outlined" square={false} sx={{minHeight: '800px', height: '100%'}}>
                <AboutFishAndWildlife />
