...
export default function AnalyzeProjectSiteLeftColumn(props) {
  ...
  return (
    <Box sx={{ height: "100%", width: "100%" }}>
      ...
      <StyledBox
        style={{
          height: analyzeAreaVisible
            ? ` calc(100% - (258px + ${extraSpace}))`
            : ` calc(100% - (58px + ${extraSpace})`,
        }}
      >
        {!chartCard.props.chartData ? (
          noDataState
