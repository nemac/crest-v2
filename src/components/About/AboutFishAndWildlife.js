  ...
  return (
    <div>
      ...
      <Typography variant="body" component="div" px={3} py={1} gutterBottom>
        The Fish and Wildlife Index identifies areas on the landscape where species and their
        ...
        a single Fish and Wildlife Index, methods vary between the continental U.S. (CONUS) and
      ...
      <Typography variant="body" component="div" px={3} py={1} gutterBottom>
        ...
        assessments in Puerto Rico, the U.S. Virgin Islands, and the Northern Mariana
        Islands combine Terrestrial and Marine Indices. Unlike CONUS, the Terrestrial Index
        attempts to identify suitable habitat based on the habitat preferences of major
        taxonomic groups (e.g., birds, reptiles, mammals, amphibians, and freshwater fishes
        and invertebrates). The Marine Index considers habitat to a 30-meter depth contour,
        utilizing the best available data to identify marine habitat types capable of
        supporting significant biodiversity (e.g., coral reefs, mangroves, and seagrass beds).
        CREST automatically displays the results for each region based on the method applied.
