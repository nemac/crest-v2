...
import { renderWithProviders } from '../setup/setupTests';
...
describe('Layer', () => {
    it('renders', () => {
        renderWithProviders(<Layer layerData={regions['American Samoa'].layerList[0]}/>)
    })
    ...
    it('updates the store', () => {
        ...
        const { store } = renderWithProviders(<Layer layerData={regions['American Samoa'].layerList[0]}/>)
