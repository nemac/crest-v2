    ...
    >
      <Grid xs={12}>
        <Box
          sx={{
            width: "100%",
            backgroundColor: (theme) => theme.palette.CRESTDark.main,
          }}
        >
          <Box
            px={2}
            sx={{
              backgroundColor: (theme) =>
                theme.palette.CRESTGridBackground.main,
            }}
          >
            <Tabs
              value={value}
            ...
            >
              <StyledAboutTab
                label="About CREST"
                {...a11yProps(0, "about-tab")}
              />
              <StyledAboutTab
                label="About Community Exposure"
                {...a11yProps(1, "about-tab")}
              />
              <StyledAboutTab
                label="About Fish and Wildlife"
                {...a11yProps(2, "about-tab")}
              />
              <StyledAboutTab
                label="About Resilience Hubs"
                {...a11yProps(3, "about-tab")}
              />
            </Tabs>
          </Box>
