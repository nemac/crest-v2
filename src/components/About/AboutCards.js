...
import DescriptionMainAboutCard from '../components/About/DescriptionMainAboutCard';
...
export default function About() {
  ...
  return (
    <div>
      <DescriptionMainAboutCard
        descriptionTitle={'About CREST'}>
        <Typography variant="body" component="div" align="start" px={2} py={1} gutterBottom>
